...
import { fileSystemToolDefinitions, fileSystemPlugin } from '../plugins/file-system.js';
...
export const agentCreatorAgent =
  (options: AgentCreatorOptions): MelonyPlugin<ConversationState, ConversationEvent> =>
  (builder) => {
