...
OpenBot is a powerful, extensible AI assistant framework built on top of the `melony` orchestration library. It provides a Slack-like workspace where specialized agents are invoked via @mentions and collaborate.

## Key Features

- **Agent Orchestration**: Invoke specialized agents via @mentions in channels and DMs (e.g., OS, Topic, or custom YAML agents).
